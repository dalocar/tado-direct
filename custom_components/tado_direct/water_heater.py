"""Support for Tado Direct hot water zones."""
...
async def async_setup_entry(
    ...
    """Set up the Tado Direct water heater platform."""
...
async def _generate_entities(coordinator: TadoDirectDataUpdateCoordinator) -> list:
...
async def create_water_heater_entity(
    ...
    """Create a Tado Direct water heater device."""
...
class TadoDirectWaterHeater(TadoDirectZoneEntity, WaterHeaterEntity):
    """Representation of a Tado Direct water heater."""
    ...
    def __init__(
        ...
        """Initialize of Tado Direct water heater entity."""
