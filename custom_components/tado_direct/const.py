"""Constant values for the Tado Direct component."""
...
# PyTado HVAC action constants (defined inline, replacing PyTado.const imports)
...
CONF_USE_LEGACY_AUTH = "use_legacy_auth"
DATA = "data"
...
SIGNAL_TADO_UPDATE_RECEIVED = "tado_direct_update_received_{}_{}_{}"
SIGNAL_TADO_MOBILE_DEVICE_UPDATE_RECEIVED = "tado_direct_mobile_device_update_received_{}"
UNIQUE_ID = "unique_id"
