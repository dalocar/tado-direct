"""Support for Tado Direct sensors for each zone."""
...
from .entity import TadoDirectHomeEntity, TadoDirectZoneEntity

_LOGGER = logging.getLogger(__name__)


@dataclass(frozen=True, kw_only=True)
class TadoDirectSensorEntityDescription(SensorEntityDescription):
    """Describes Tado Direct sensor entity."""
...
HOME_SENSORS = [
    TadoDirectSensorEntityDescription(
...
TEMPERATURE_ENTITY_DESCRIPTION = TadoDirectSensorEntityDescription(
    key="temperature",
...
HUMIDITY_ENTITY_DESCRIPTION = TadoDirectSensorEntityDescription(
    key="humidity",
...
TADO_MODE_ENTITY_DESCRIPTION = TadoDirectSensorEntityDescription(
    key="tado mode",
    translation_key="tado_mode",
    state_fn=lambda data: data.tado_mode,
)
HEATING_ENTITY_DESCRIPTION = TadoDirectSensorEntityDescription(
    key="heating",
...
AC_ENTITY_DESCRIPTION = TadoDirectSensorEntityDescription(
    key="ac",
    translation_key="ac",
    name="AC",
...
async def async_setup_entry(
    ...
    """Set up the Tado Direct sensor platform."""
    ...
    entities.extend(
        [
            TadoDirectHomeSensor(tado, entity_description)
...
class TadoDirectHomeSensor(TadoDirectHomeEntity, SensorEntity):
    """Representation of a Tado Direct Sensor."""

    entity_description: TadoDirectSensorEntityDescription
    ...
    def __init__(
        ...
        """Initialize of the Tado Direct Sensor."""
...
class TadoDirectZoneSensor(TadoDirectZoneEntity, SensorEntity):
    """Representation of a Tado Direct Sensor."""
