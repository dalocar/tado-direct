"""Support for Tado Direct thermostats."""
...
async def async_setup_entry(
    ...
    """Set up the Tado Direct climate platform."""
...
async def create_climate_entity(
    ...
    zone_id: int,
    device_info: dict,
) -> TadoDirectClimate | None:
    """Create a Tado Direct climate entity."""
...
class TadoDirectClimate(TadoDirectZoneEntity, ClimateEntity):
    """Representation of a Tado Direct climate entity."""
    ...
    def __init__(
        ...
        """Initialize of Tado Direct climate entity."""
        ...
        self._tado_zone_data: TadoZone | dict = {}
    ...
    async def _control_hvac(
        ...
        _LOGGER.debug(
            (
                "Switching to %s for zone %s (%d) with temperature %s and duration"
                " %s using overlay %s"
            ),
